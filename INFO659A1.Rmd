---
title: "EDA with a Credit Card Fraud Detection dataset using CorrPlot"
...
```{r}
hist(log10(dataName$Amount), breaks=10, col="gray", xlab="log10(Amount)", main="Distribution of feature log10(Amount)") 
```
...
```
```{r}
hist(dataName$Amount[dataName$Amount < 5], col="gray", xlab="Amount < 5", main="Distribution of feature Amount < 5")
```
...
```
```{r echo=FALSE}
hist(dataName$Amount[dataName$Amount < 50], col="gray", xlab="Amount < 50", main="Distribution of feature Amount < 50")
```
```{r echo=FALSE}
length(dataName$Amount[dataName$Amount < 100])/length(dataName$Amount) * 100
```
```{r echo=FALSE}
hist(dataName$Amount[dataName$Amount < 100], col="gray", xlab="Amount < 100", main="Distribution of feature Amount < 100")
```
```{r echo=False}
length(dataName$Amount[dataName$Amount < 300])/length(dataName$Amount) * 100
```
```{r echo=FALSE}
hist(dataName$Amount[dataName$Amount < 300], col="gray", xlab="Amount < 300", main="Distribution of feature Amount < 300")
```
